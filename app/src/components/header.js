    ...
    <div>
      ...
      InputProps={{
        ...
        (<InputAdornment position="start">
          <GridViewIcon />
          <Typography sx={{marginLeft: 1}}>Extension</Typography>
        </InputAdornment>
  ),
        endAdornment:
          <InputAdornment position="end">
            <Box sx={{backgroundColor: "#2f354c", height: 30, width: 30, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 1, cursor: "pointer"}}>
              <AcUnitIcon sx={{fontSize: "medium", color: "white"}}/>
            </Box>
          </InputAdornment>
      }}
      variant="outlined" />
